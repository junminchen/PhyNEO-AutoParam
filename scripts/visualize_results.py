...
def generate_multi_physics_plots():
    # 1. Load Data
    ...
    pred = model.apply(variables, mol_obj.get_graph(), total_charge=float(Chem.GetFormalCharge(mol_obj.rdmol)))
    ...
    output_path = "examples/plots/vec_all_physics_parity.png"
    plt.savefig(output_path, dpi=300)
    print(f"Combined physics parity plot saved to {output_path}")

if __name__ == "__main__":
    generate_multi_physics_plots()
